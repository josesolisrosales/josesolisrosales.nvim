...
require('lazy').setup({
  ...
  -- Fuzzy Finder (files, lsp, etc)
  {
    ...
    config = function()
      ...
      -- Your custom telescope functions
  ...
  -- Autocompletion - Modern Blink.cmp
  {
    'saghen/blink.cmp',
    event = 'VimEnter',
    version = '1.*',
  ...
  -- Lualine statusline (your configuration)
  {
...
-- Terminal keymaps
vim.api.nvim_set_keymap('n', '<C-`>', ':lua TermToggle(12)<cr>', { noremap = true, silent = true, desc = 'Toggle Terminal' })
vim.api.nvim_set_keymap('t', '<C-`>', '<C-\\><C-n>:lua TermToggle(12)<cr>', { noremap = true, silent = true, desc = 'Toggle Terminal' })
